...
output_path = "/root/workspace/github.com/CoDanTheBarbarian/5e_character_creator/pdf/Checkbox_parsing.pdf"
...
fields_key = {
          ...
          'checkbox_368amxh': None, # the server timed out here, I think I was making too many requests to parse this out
...
fillpdfs.write_fillable_pdf(template_path, output_path, fields_key)